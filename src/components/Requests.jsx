  ...
  return (
    <div className="h-full overflow-y-auto p-3 sm:p-4 lg:p-6 space-y-3 sm:space-y-4 bg-gradient-to-br from-pink-500 via-purple-600 to-indigo-600">
      ...
      {requests.map((request) => {
        if (!request.fromuserId) return null; // ✅ skip if user deleted
        ...
        return (
          <motion.div
            key={request._id} // ✅ use MongoDB _id
          ...
          >
            ...
            <div className="flex border-t border-gray-100">
              <button
                onClick={() => reviewRequest("rejected", request._id)} // ✅ send correct id
              ...
              <button
                onClick={() => reviewRequest("accepted", request._id)} // ✅ send correct id
